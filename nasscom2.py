...
income=int(input("Enter 0/1/2/3/4 if- no income/low/med/high/gov income:"))
...
working=int(input("Enter 0/1/2/3/4 for working options- never/home/stopped/travel critical/travel non critical:"))
